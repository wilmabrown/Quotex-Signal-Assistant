...
class SignalsStocksScreen extends StatelessWidget {
  const SignalsStocksScreen({Key? key}) : super(key: key);
  ...
  Widget _buildContent(BuildContext context) {
    return Observer(
      builder: (context) => ListView.builder(
        ...
        itemCount: state.stocksSignals.length,
        itemBuilder: (context, index) => SignalWrapper(
          signal: state.stocksSignals.elementAt(index),
          onlyFirst: true,
        ),
      ),
    );
